...
const wallet = new Wallet({
  HDPublicKey:
    "tpubDFLd6pf4VJ72YFdAVp5sXWiszJhGM4yhXnAYkXagFf2fS3NiTU6rwQsxkMiVPKqeGBTWC2DZ8ZicuT49jnKwMEr6gAT4f83YqB3dnujarD3",
  network: "testnet",
});
...
wallet.getAccount().then(async (account) => {
  ...
  account.on(EVENTS.PREFETCHED, () =>
    logger.info("EVENTS_PREFETCHED", EVENTS.PREFETCHED)
  );
  account.on(EVENTS.DISCOVERY_STARTED, () =>
    logger.info("EVENTS_DISCOVERY_STARTED", EVENTS.PREFETCHED)
  );
});

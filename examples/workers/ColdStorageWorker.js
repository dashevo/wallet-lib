...
class ColdStorageWorker extends Worker {
  constructor(props) {
    super({
      ...
      dependencies: ["walletConsolidator", "getUTXOS", "getConfirmedBalance"],
    });
    if (!props.address) {

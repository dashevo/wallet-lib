...
const {
  ...
  fd7c727155ef67fd5c1d54b73dea869e9690c439570063d6e96fec1d3bba450e,
} = transactionsFixtures.valid.mainnet;
describe("Storage - searchTransaction", function suite() {
  ...
  it("should find a transaction", () => {
    ...
    const existingTxID =
      faa430b0fe84a074d981e6fa3995a13363478415ca029a12f6432bf3d90dfa60.hash;
    const notExistingTxID =
      fd7c727155ef67fd5c1d54b73dea869e9690c439570063d6e96fec1d3bba450e.hash;
    ...
    expect(search.result).to.be.equal(
      faa430b0fe84a074d981e6fa3995a13363478415ca029a12f6432bf3d90dfa60
    );

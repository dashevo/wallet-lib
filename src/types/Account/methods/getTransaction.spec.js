...
describe("Account - getTransaction", function suite() {
  ...
  it("should correctly get a existing transaction", async () => {
    const tx = await getTransaction.call(
      mockedWallet,
      "92150f239013c961db15bc91d904404d2ae0520929969b59b69b17493569d0d5"
    );
  ...
  it("should correctly try to fetch un unexisting transaction", async () => {
    ...
    const tx = await getTransaction.call(
      mockedWallet,
      "92151f239013c961db15bc91d904404d2ae0520929969b59b69b17493569d0d5"
    );
  ...
  vout: [
    {
      ...
      spentTxId:
        "eabe39ada39b58d70c03e0e79b7d2c767ed1239dda436bbc5a58954285421acc",
      spentIndex: 1,
      spentHeight: 30969,
    },
    {
      ...
      spentTxId:
        "5a5626c59f3830d5d9e7261bed5ced2694a343100c18d4a730b26639f5832944",
      spentIndex: 0,
      spentHeight: 29197,
    },
  ],

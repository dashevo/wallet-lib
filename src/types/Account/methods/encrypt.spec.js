...
describe("Account - encrypt", function suite() {
  ...
  it("should encrypt extPubKey with aes", () => {
    const extPubKey = account.keyChain
      .getKeyForPath(derivationPath, "HDPublicKey")
      .toString();
    const encryptedExtPubKey = account
      .encrypt("aes", extPubKey, secret)
      .toString();
  ...
  it("should encrypt a encoded json", () => {
    ...
    const decryptedEncodedJSON = CryptoJS.AES.decrypt(
      encryptedJSON,
      secret

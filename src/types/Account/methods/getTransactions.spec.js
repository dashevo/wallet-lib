...
const mockedStore = {
            ...
            utxos: [
              {
                ...
                outputIndex: 0,
                scriptPubKey:
                  "76a914f8c2652847720ab6d401291e5a48e2c8fe5d3c9f88ac",
                satoshis: 100000000,
              },
            ],
          },
  ...
  transactions: {
    "9ab39713e9ce713d41ca6974db83e57bced02402e9516b8a662ed60d5c08f6d1": {
      blockhash:
        "000000000a84c4703da7a69cfa65837251e4aac80e1621f2a2cc9504e0c149ba",
      blockHeight: 201436,
      ...
      vout: [
        {
          ...
          scriptPubKey: {
            ...
            addresses: ["ygewiYb7ZJxU4uuNGEVzbbA3wZEpEQJKhr"],
            type: "pubkeyhash",
          },
          spentTxId:
            "6b90bf01b10a0c6cac018d376823f6b330edf2cbb783cc3d02004f8706bbc311",
          spentIndex: 7,
          spentHeight: 203517,
        },
        {
          ...
          scriptPubKey: {
            ...
            addresses: ["yinidcHwrfzb4bEJDSq3wtQyxRAgQxsQia"],
            type: "pubkeyhash",
          },
          spentTxId:
            "22c368e09ad8b36553b383c6a4ae989f91d1f66622b2b685262580c8a45175a4",
          spentIndex: 0,
          spentHeight: 203155,
        },
      ],
      ...
      vout: [
        {
          ...
          scriptPubKey: {
            ...
            addresses: ["yizmJb63ygipuJaRgYtpWCV2erQodmaZt8"],
            type: "pubkeyhash",
          },
          spentTxId:
            "1d8f924bef2e24d945d7de2ac66e98c8625e4cefeee4e07db2ea334ce17f9c35",
        ...
        },
        {
          ...
          scriptPubKey: {
            ...
            addresses: ["yXjag2zjTwA5Ya2sSV5KoFzTvE6uKdrnKa"],
            type: "pubkeyhash",
          },
          spentTxId:
            "6ca8795f2534972e1371249c3d7b6c5095e1513bc8cc351eeaa2f364020dbc01",
          spentIndex: 1,
          spentHeight: 203674,
        },
      ],
    ...
    "1d8f924bef2e24d945d7de2ac66e98c8625e4cefeee4e07db2ea334ce17f9c35": {
      ...
      blockhash:
        "0000000002922d7d0a69ce3e29908dc26aba6565af760d208dac77a8b520fbf3",
      blockHeight: 204161,
      ...
      vout: [
        {
          ...
          scriptPubKey: {
            ...
            addresses: ["yiUjSkhkAfaHfYYmTMhc27NCmogJ3iRBaS"],
            type: "pubkeyhash",
          },
          spentTxId: null,
          spentIndex: null,
        ...
        },
        {
          ...
          scriptPubKey: {
            ...
            addresses: ["yTM7nPiekjMBkMCU6cPmFD2KReeFUeVwCp"],
            type: "pubkeyhash",
          },
          spentTxId: null,
          spentIndex: null,

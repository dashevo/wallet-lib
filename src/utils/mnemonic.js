 ...
 * @return {HDPrivateKey}
 */
function mnemonicToHDPrivateKey(
  mnemonic,
  network = "testnet",
  passphrase = ""
) {
...
const mnemonicToSeed = function mnemonicToSeed(mnemonic, password = "") {
  ...
  return pbkdf2Sync(mnemonicBuff, saltBuff, 2048, 64, "sha512").toString("hex");
};
// See https://github.com/bitcoin/bips/blob/master/bip-0032.mediawiki
const seedToHDPrivateKey = function seedToHDPrivateKey(
  seed,
  network = "testnet"
) {

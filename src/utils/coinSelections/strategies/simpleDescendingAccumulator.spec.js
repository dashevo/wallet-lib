...
console.error(
  "coinSelection.strategies.simpleDescendingAccumulator needs a rebuilt store"
);
describe.skip("CoinSelection - Strategy - simpleDescendingAccumulator", () => {
  it("should work as expected", () => {
    ...
    const res1e4 = simpleDescendingAccumulator.call(
      self,
      utxosList,
      outputsList1e4
    );
    ...
    const res1e6 = simpleDescendingAccumulator.call(
      self,
      utxosList,
      outputsList1e6
    );
    const res1e7 = simpleDescendingAccumulator.call(
      self,
      utxosList,
      outputsList1e7
    );
    const res1e8 = simpleDescendingAccumulator.call(
      self,
      utxosList,
      outputsList1e8
    );
    const res1e9 = simpleDescendingAccumulator.call(
      self,
      utxosList,
      outputsList1e9
    );
    const res1e10 = simpleDescendingAccumulator.call(
      self,
      utxosList,
      outputsList1e10
    );
    const res2e10 = simpleDescendingAccumulator.call(
      self,
      utxosList,
      outputsList2e10
    );
    ...
    expect(() =>
      simpleDescendingAccumulator.call(self, utxosList, outputsList1e11)

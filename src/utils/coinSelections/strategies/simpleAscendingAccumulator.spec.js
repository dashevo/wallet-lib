...
describe("CoinSelection - Strategy - simpleAscendingAccumulator", () => {
  describe.skip("it should pass - requires FakeNet", () => {
    it("should work as expected", () => {
      ...
      const outputsList1e4 = [
        { address: "yU7sNM4j6fzKtbah24gCXdN636piQN8F2f", satoshis: 1e4 },
      ];
      const outputsList1e5 = [
        { address: "yU7sNM4j6fzKtbah24gCXdN636piQN8F2f", satoshis: 1e5 },
      ];
      const outputsList1e6 = [
        { address: "yU7sNM4j6fzKtbah24gCXdN636piQN8F2f", satoshis: 1e6 },
      ];
      const outputsList1e7 = [
        { address: "yU7sNM4j6fzKtbah24gCXdN636piQN8F2f", satoshis: 1e7 },
      ];
      const outputsList1e8 = [
        { address: "yU7sNM4j6fzKtbah24gCXdN636piQN8F2f", satoshis: 1e8 },
      ];
      const outputsList1e9 = [
        { address: "yU7sNM4j6fzKtbah24gCXdN636piQN8F2f", satoshis: 1e9 },
      ];
      const outputsList1e10 = [
        { address: "yU7sNM4j6fzKtbah24gCXdN636piQN8F2f", satoshis: 1e10 },
      ];
      const outputsList2e10 = [
        { address: "yU7sNM4j6fzKtbah24gCXdN636piQN8F2f", satoshis: 2e10 },
      ];
      const outputsList6e10 = [
        { address: "yU7sNM4j6fzKtbah24gCXdN636piQN8F2f", satoshis: 6e10 },
      ];
      ...
      const outputsList1e11 = [
        { address: "yU7sNM4j6fzKtbah24gCXdN636piQN8F2f", satoshis: 1e11 },
      ];
        ...
        utxos: [
          {
            ...
            script: "76a9143a9202121ee9ef906e567101326f2ecf8ad4ecbc88ac",
          },
        ],
        outputs: [
          {
      ...
      const expectedRes999e8 = {
        utxos: [
          ...
          {
            satoshis: 1088887528,
            script: "76a9144f8aa6c3e302911b8c6b0ecb0538d209c144f84988ac",
          },
          {
            satoshis: 10000000000,
            script: "76a9143a9202121ee9ef906e567101326f2ecf8ad4ecbc88ac",
      ...
      const res1e4 = simpleAscendingAccumulator.call(
        self,
        utxosList,
        outputsList1e4
      );
      const res1e5 = simpleAscendingAccumulator.call(
        self,
        utxosList,
        outputsList1e5
      );
      const res1e6 = simpleAscendingAccumulator.call(
        self,
        utxosList,
        outputsList1e6
      );
      const res1e7 = simpleAscendingAccumulator.call(
        self,
        utxosList,
        outputsList1e7
      );
      const res1e8 = simpleAscendingAccumulator.call(
        self,
        utxosList,
        outputsList1e8
      );
      const res1e9 = simpleAscendingAccumulator.call(
        self,
        utxosList,
        outputsList1e9
      );
      const res1e10 = simpleAscendingAccumulator.call(
        self,
        utxosList,
        outputsList1e10
      );
      const res2e10 = simpleAscendingAccumulator.call(
        self,
        utxosList,
        outputsList2e10
      );
      const res6e10 = simpleAscendingAccumulator.call(
        self,
        utxosList,
        outputsList6e10
      );
      const res999e8 = simpleAscendingAccumulator.call(
        self,
        utxosList,
        outputsList999e8
      );
      ...
      expect(() =>
        simpleAscendingAccumulator.call(self, utxosList, outputsList1e11)
      ).to.throw("Unsufficient utxo amount");
    });
  });
});

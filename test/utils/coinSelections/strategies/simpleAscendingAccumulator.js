...
describe('CoinSelection - Strategy - simpleAscendingAccumulator', () => {
  it('should work as expected', () => {
    ...
    expect(simpleAscendingAccumulator.call(self, utxosList, outputsList1e4)).to.deep.equal(expectedRes1e4);
    expect(simpleAscendingAccumulator.call(self, utxosList, outputsList1e5)).to.deep.equal(expectedRes1e5);
    expect(simpleAscendingAccumulator.call(self, utxosList, outputsList1e6)).to.deep.equal(expectedRes1e6);
    expect(simpleAscendingAccumulator.call(self, utxosList, outputsList1e7)).to.deep.equal(expectedRes1e7);
    expect(simpleAscendingAccumulator.call(self, utxosList, outputsList1e8)).to.deep.equal(expectedRes1e8);
    expect(simpleAscendingAccumulator.call(self, utxosList, outputsList1e9)).to.deep.equal(expectedRes1e9);
    expect(simpleAscendingAccumulator.call(self, utxosList, outputsList1e10)).to.deep.equal(expectedRes1e10);
    expect(simpleAscendingAccumulator.call(self, utxosList, outputsList2e10)).to.deep.equal(expectedRes2e10);
    expect(simpleAscendingAccumulator.call(self, utxosList, outputsList6e10)).to.deep.equal(expectedRes6e10);
    expect(simpleAscendingAccumulator.call(self, utxosList, outputsList999e8)).to.deep.equal(expectedRes999e8);

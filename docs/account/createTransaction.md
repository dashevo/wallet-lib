...
- **simpleDescendingStrategy** : Will try to use as much small inputs as possible up to meeting the necessary amount required.  
...
- **simpleAscendingStrategy** : Will try to use as much small inputs as possible up to meeting the necessary amount required.  
    Allow to get rid of many small inputs at the cost of potential bigger fee.
